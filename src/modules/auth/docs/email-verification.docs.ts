...
import { ApiOkResponse, ApiGoneResponse, ApiBadRequestResponse, ApiNotFoundResponse, ApiInternalServerErrorResponse, ApiBody, ApiResponse, ApiOperation, ApiConflictResponse } from '@nestjs/swagger';
 ...
 return applyDecorators(
  ApiOkResponse({
   ...
   schema: {
    type: "object",
    properties: {
     message: { type: 'string', example: "Account verification successful" },
 ...
 return applyDecorators(
  ApiOkResponse({
   ...
   schema: {
    type: "object",
    properties: {
     message: { type: 'string', example: "Check your mail, verification email sent!" },
     status_code: { type: 'number', example: HttpStatus.OK }
    }
   }
  }),
  ...
  ApiInternalServerErrorResponse({
   ...
   schema: {
    ...
    properties: {
     ...
     status_code: { type: 'number', example: HttpStatus.INTERNAL_SERVER_ERROR }
    }
   }
  }),
 )
